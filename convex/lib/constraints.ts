...
export const CHAT_RAG_RESULT_LIMIT = 6;
export const CHAT_RAG_MAX_CONTEXT_CHARS = 12000;
export const CHAT_RAG_RATE_LIMIT_PER_MINUTE = 20;

export const TEST_GEN_KB_CONTEXT_CHARS = 6000;
